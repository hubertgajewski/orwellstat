...
| `utils/navigation.util.test.ts`            | Title navigation readiness        | Covers navigation commit options plus missing and non-OK navigation response failures before title assertions run.                                                             |
